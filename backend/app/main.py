...
async def lifespan(app: FastAPI):
    # Startup
    logger.info("🚀 Starting fun2learn Online - AI Question Generator")
...
app = FastAPI(
    title="fun2learn Online - AI Question Generator",
...
async def root():
    ...
    return {
        "message": "fun2learn Online - AI Question Generator API",
        "version": "0.1.0",
        "docs": "/docs"
    }
