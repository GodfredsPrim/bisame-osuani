...
class PDFGenerator:
    ...
    def generate_exam_pdf(
        ...
        elements.append(Paragraph(f"fun2learn online OFFICIAL MOCK EXAMINATION — {year}", self.styles['WAEC_Subtitle']))
    ...
    def _add_footer(self, canvas: canvas.Canvas, doc):
        ...
        footer_text = "Page %d of %s | fun2learn online Educational Resources | WASSCE Prep" % (doc.page, "...") # Simplified doc page count
