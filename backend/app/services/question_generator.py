...
"""
        ...
        return f"""Generate {num_questions} distinct {difficulty} level {question_type.value.replace('_', ' ')} questions for fun2learn Online {display_subject} ({year_key.replace('_', ' ').title()}){semester_context}.

Requirements:
1. Follow the pattern and style of typical fun2learn Online exam questions.
